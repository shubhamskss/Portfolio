        ...
        <Row>
          {/* <Col md={8} className="home-about-description">
            ...
            <p className="home-about-body">
              ...
              <br />
              <br />
              My primary focus and major contributions lie in{" "}
              <i>
                <b className="purple">backend development</b>
              </i>
              , where I work extensively with{" "}
              <i>
              ...
              <ul>
                <li>
                  Cloud services like{" "}
                  <i>
                    <b className="purple">AWS EC2</b>
                  </i>{" "}
                  and{" "}
                  <i>
                    <b className="purple">S3</b>
                  </i>.
                </li>
                <li>
                  Databases such as{" "}
                  <i>
                    <b className="purple">MongoDB, MySQL, Redis,</b>
                  </i>{" "}
                  and{" "}
                  <i>
                    <b className="purple">Elasticsearch</b>
                  </i>.
                </li>
                <li>
              ...
              , and I have experience with templating engines like{" "}
              <i>
                <b className="purple">Pug</b>
              </i>{" "}
              and{" "}
              <i>
                <b className="purple">EJS</b>
              </i>.
              <br />
              <br />
              Additionally, I have worked with tools like{" "}
              <i>
              ...
              for real-time communication and notifications.
              <br />
              <br />
              Currently, as a Software Developer at{" "}
              <span className="purple">Gopaisa Netventures</span>, I am responsible for backend and API development, database design, and creating intuitive user management panels for streamlined product management.
              <br />
              <br />
